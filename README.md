...
Bugs and missing functionality compared to dbt Core will be resolved continuously in the leadup to a final release (see [this post](https://www.getdbt.com/blog/where-we-re-headed-with-the-dbt-fusion-engine) for more details). 
