    ...
    pub fn to_eval_args(&self, arg: SystemArgs, in_dir: &Path, out_dir: &Path) -> EvalArgs {
        ...
        EvalArgs {
            ...
            io: IoArgs {
                ...
                use_parquet_schema_store: arg.io.use_parquet_schema_store,
                verify_parquet_schema_store: arg.io.verify_parquet_schema_store,
                host: arg.io.host,
                port: arg.io.port,
...
pub fn from_main(cli: &Cli) -> SystemArgs {
    ...
    SystemArgs {
        ...
        io: IoArgs {
            ...
            use_parquet_schema_store: false,
            verify_parquet_schema_store: false,
