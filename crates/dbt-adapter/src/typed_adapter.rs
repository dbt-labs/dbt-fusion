...
impl ConcreteAdapter {
    ...
    pub fn submit_python_job(
        ...
        match self.inner_adapter() {
            ...
            Replay(
                ...
                | Fabric | ClickHouse | Starburst | Athena | Trino | Dremio
                | Oracle),
                _,
            )
            | Impl(
    ...
    pub fn truncate_relation(
        ...
        match self.inner_adapter() {
            ...
            Impl(
                ...
                | DuckDB | Fabric | ClickHouse | Starburst | Athena | Trino | Dremio | Oracle,
                _,
            ) => {
                // downcast relation
    ...
    pub fn update_columns_descriptions(
        ...
        match self.adapter_type() {
            ...
            | Fabric | DuckDB | ClickHouse | Starburst | Athena | Trino | Dremio | Oracle => {
    ...
    pub fn get_constraint_support(&self, ct: ConstraintType) -> ConstraintSupport {
        ...
        match (self.adapter_type(), ct) {
            ...
            // Salesforce
            (Salesforce | Spark | ClickHouse | Starburst | Athena | Trino | Dremio | Oracle, _) => {
...
pub(crate) fn adapter_specific_behavior_flags(adapter_type: AdapterType) -> Vec<BehaviorFlag> {
    match adapter_type {
        ...
        | Athena | Trino | Dremio | Oracle => vec![],
    }
}
