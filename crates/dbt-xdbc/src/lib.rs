...
pub const SNOWFLAKE_DRIVER_VERSION: &str = "0.21.0+dbt0.21.6";
pub const BIGQUERY_DRIVER_VERSION: &str = "0.21.0.dev+dbt0.21.7";
...
pub const DUCKDB_DRIVER_VERSION: &str = "0.21.0+dbt0.0.6";
